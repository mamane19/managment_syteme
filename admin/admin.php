<?php 
    # interface principale administrateur
    //debut de la session
    session_start();
    # verifie si une session exite ou redirige vers login
        ...
        <div class="tile is-vertical is-parent">
            ...
            <main class="" id="main">
                ...
                <section class="tile is-ancestor">
                    <div class="tile is-vertical is-parent">
                        <?php
                            # cherche les tous projets de l’admin connecté
                            $proj = "SELECT * FROM agence.projet 
                                     WHERE projet.id_responsable = $id_responsable;" ;
                        ...
                        ?>  
                        <!--< affiche les projets en différenciant leur état en couleurs >-->
                        <?php if ($row['etat']=="a_venir") {?>
                            <article class="tile is-child box message is-info">
                                <div class="message-header">
                                    <p class="has-text-right is-uppercase">
                                        <?php echo $row['nom'].' &bull; '.$row['type']; ?>
                                    </p>
                                    <a data-id="<?php echo $row['id'] ; ?>" onclick="getId(this)" data-toggle="tooltip" data-placement="top" title="Ajouter une phase"data-izimodal-open="#nouv-phase" data-iziModal-transitionOut="fadeOutDown" data-izimodal-transitionin="fadeInDown">
                                        <i class="fab fa-buffer"></i>
                                    </a>
                                    <a data-id="<?php echo $row['id'] ; ?>" onclick="getId(this)" data-toggle="tooltip" data-placement="top" title="D&eacute;marrer" data-izimodal-open="#start" data-iziModal-transitionOut="fadeOutDown" data-izimodal-transitionin="fadeInDown">
                                                ...
                                                ?>
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><span></span><?php echo $tache_phase['nom'] ; ?></td>
