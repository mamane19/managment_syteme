    ...
    <div class="tile is-ancestor ">
        ...
        <div class="tile is-vertical is-parent">
            ...
            <main class="tile is-child " id="main">
                <section class="box is-child message is-info">
                    <div class="message-header menu-label">
                        ...
                        <?php
                            ...
                            echo $nb ;
                        ?>
                        projet(s) <!--< nombre de projets à venir par l’admin connecté ; >-->
                ...
                <section class="tile is-ancestor">
                    <div class="tile is-vertical is-parent">
                        <?php
                            ...
                            $proj = "SELECT * FROM agence.projet WHERE projet.etat = 'a_venir'
                                      AND projet.id_responsable = $id_responsable;" ;
